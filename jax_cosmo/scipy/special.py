# Implementation taken from https://github.com/scipy/scipy/blob/master/scipy/special/_loggamma.pxd
# and here https://github.com/adam-coogan/jax/blob/gamma-complex/third_party/scipy_special_gamma/gamma.py
import jax
...
def loggamma_stirling(z):
    ...
    rz = 1.0 / z
    rzz = rz / z
    return (z - 0.5) * jnp.log(z) - z + HLOG2PI + rz * jnp.polyval(coeffs, rzz)
...
def loggamma_taylor(z):
    ...
    z = z - 1
    return z * jnp.polyval(coeffs[::-1], z)


loggamma_vector = jax.jit(jax.vmap(loggamma))
